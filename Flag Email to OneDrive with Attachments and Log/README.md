# Flag Email to OneDrive with Attachments and Excel Log

## Summary
This PowerAutomate flow sends emails to OneDrive when you flag them for follow up. It also saves attachments, and creates an Excel sheet with a log of all attachments.
